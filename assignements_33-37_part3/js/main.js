...
if (num3 > num1 && num3 == num2 && typeof num3 !== typeof num1) {
    console.log(
        `${num3} Is Larger Than ${num1} And Value Is The Same As ${num2} And Type ${typeof num3} Not The Same Type As ${typeof num1}`
    );
}
